...
function generateSudoku() {
  ...
  function displaySudoku(){
    $(document).ready(function() {
      ...
      var chaineSudoku = '<div class="container">';
      for (var i = 0; i < 9; i++) {
        chaineSudoku += `<div id="row${i}" class="row">`;
          for (var j = 0; j < 9; j++) {
            chaineSudoku += `<div id="col${j}" class="col-1 case">${sudoku[i][j]}</div>`;
          }
          chaineSudoku += '</div>';
      }
      chaineSudoku += '</div>';
  
      $("#sudoku").html(chaineSudoku);
